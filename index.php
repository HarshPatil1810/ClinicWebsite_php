...
$query->bindParam(':message',$message,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Your Appointment Request Has Been Send. We Will Contact You Soon, Please Check Your Appointment Status within 2 Days.")</script>';
                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active" data-interval="4000" >
                                        <img src="images/slider/Dr.jpg" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item" data-interval="4000" >
                                        <img src="images/slider/Spine3.jpg" class="img-fluid" alt="">
                                    </div>
